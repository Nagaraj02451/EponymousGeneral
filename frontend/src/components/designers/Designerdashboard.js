...
function Designerdashboard() {
    ...
    function childvalucliked2(e) {
        const { name, value } = e.target;
            ...
            //    datas2.length > 0 setParent2Value(name)
        if (e.target.checked) {
            setDatas2(prevDatas => [...prevDatas, { name, value }]);
            setParent2Value(name)
        } else {
    ...
    useEffect(() => {
        if (isProductCreated) {
            toast('Designers Approved Succesfully!', {
                type: 'success',
                                        ...
                                        >
                                            ...
                                            <div class="datascollection" >
                                                ...
                                                ><input name='label' onChange={e => setlabel(e.target.value)}
                                                    value={label} type='text' placeholder='Labels' />
                                            ...
                                            <div  >
                                                ...
                                                <div className='uytfyugiu'>
                                                    <div className='iyuguym'>
                                                        <label>
                                                            <input type="checkbox" onClick={(e) => setspecialisation(e.target.value)} name="group" id="elementdataa" value="Clothing" />
                                                            CLOTHING
                                                        </label>
                                                        <label>
                                                            <input type="checkbox" onClick={(e) => setcloth(e.target.value)} name="group" id="elementdataa" value="Jewellery" />
                                                            JEWELLERY
                                                        </label>
                                                        <label>
                                                            <input type="checkbox" onClick={(e) => setjewell(e.target.value)} name="group" id="elementdataa" value="Accessories" />
                                                            ACCESSORIES
                                                        </label>
                                                        <label>
                                                            <input type="checkbox" onClick={(e) => setaccessor(e.target.value)} name="group" id="elementdataa" value="Footwear" />
                                                            FOOTWEAR
                                                        </label>
                                                        <label>
                                                            <input type="checkbox" onClick={(e) => setfoot(e.target.value)} name="group" id="elementdataa" value="Bags" />
                                                            BAGS
                                                        </label>
                                                    </div>
                                                    <div className='uygfy'>
                                                ...
                                                <div class="wwhjgyded" >
                                                    <div className='datasinnerradio'>
                                                        ...
                                                        <div >
                                                            ...
                                                            <label id='ytg7y'>
                                                                <input id="element" name='Womenswear' type="checkbox" value="Avant-Garde" onChange={childvalucliked} />
                                                                AVANT-GARDE

                                                            </label>
                                                        </div>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Bottoms" onChange={childvalucliked} />
                                                            BOTTOMS

                                                        </label>

                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="T-Shirts" onChange={childvalucliked} />
                                                            T-SHIRTS

                                                        </label>

                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Tops" onChange={childvalucliked} />
                                                            TOPS

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Dresses" onChange={childvalucliked} />
                                                            DRESSES

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Skirts" onChange={childvalucliked} />
                                                            SKIRTS

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Beachwear" onChange={childvalucliked} />
                                                            BEACHWEAR

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input type="checkbox" name='Womenswear' value="Bridal" onChange={childvalucliked} />
                                                            BRIDAL

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Casualwear" onChange={childvalucliked} />
                                                            CASUALWEAR

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input type="checkbox" name='Womenswear' value="Couture" onChange={childvalucliked} />
                                                            COUTURE

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Denim" onChange={childvalucliked} />
                                                            DENIM

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Eveningwear" onChange={childvalucliked} />
                                                            EVENINGWEAR

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Knitwear & Sweaters" onChange={childvalucliked} />
                                                            KNITWEAR & SWEATERS

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input type="checkbox" name='Womenswear' value="Leather" onChange={childvalucliked} />
                                                            LEATHER

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Lingerie" onChange={childvalucliked} />
                                                            LINGERIE

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Modest" onChange={childvalucliked} />
                                                            MODEST

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Streetwear" onChange={childvalucliked} />
                                                            STREETWEAR

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Activewear" onChange={childvalucliked} />
                                                            ACTIVEWEAR

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Swimwear" onChange={childvalucliked} />
                                                            SWIMWEAR

                                                        </label>
                                                        <label id='ytg7y'>
                                                            <input id="element" name='Womenswear' type="checkbox" value="Workwear" onChange={childvalucliked} />
                                                            WORKWEAR
                                                    ...
                                                    <div className='datasinnerradio'>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div>
                                                                {/* Add more child buttons similarly */}
                                                                <label id='ytg7y'>
                                                                    <input type="checkbox" id="element" value="Activewear" name='Menswaer' onChange={childvalucliked2} />
                                                                    ACTIVEWEAR

                                                                </label >
                                                            </div>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Avant-Garde" name='Menswaer' onChange={childvalucliked2} />
                                                                AVANT-GARDE

                                                            </label>

                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Bottoms" name='Menswaer' onChange={childvalucliked2} />
                                                                BOTTOMS
                                                            ...
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Casualwear" name='Menswaer' onChange={childvalucliked2} />
                                                                CASUALWEAR

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Denim" name='Menswaer' onChange={childvalucliked2} />
                                                                DENIM

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Formalwear" name='Menswaer' onChange={childvalucliked2} />
                                                                FORMALWEAR

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Underwear" name='Menswaer' onChange={childvalucliked2} />
                                                                UNDERWEAR

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Jackets & Coats" name='Menswaer' onChange={childvalucliked2} />
                                                                JACKETS & COATS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Leather" name='Menswaer' onChange={childvalucliked2} />
                                                                LEATHER

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Knitwear" name='Menswaer' onChange={childvalucliked2} />
                                                                KNITWEAR

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Streetwear" name='Menswaer' onChange={childvalucliked2} />
                                                                STREETWEAR

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Swimwear" name='Menswaer' onChange={childvalucliked2} />
                                                                SWIMWEAR

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Suits & Blazers" name='Menswaer' onChange={childvalucliked2} />
                                                                SUITS & BLAZERS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="T-Shirts" name='Menswaer' onChange={childvalucliked2} />
                                                                T-SHIRTS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Tops" name='Menswaer' onChange={childvalucliked2} />
                                                                TOPS
                                                        ...
                                                        <div>
                                                            ...
                                                            <div>
                                                                {/* Add more child buttons similarly */}
                                                                <label id='ytg7y'>
                                                                    <input type="checkbox" name='Childrenswear' id="element" value="Avant-Garde" onChange={childvalucliked3} />
                                                                    AVANT-GARDE
                                                            ...
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Millinery" name='Childrenswear' onChange={childvalucliked3} />
                                                                MILLINERY
                                                    ...
                                                    <div className='datasinnerradio'>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div>
                                                                {/* Add more child buttons similarly */}
                                                                <label id='ytg7y'>
                                                                    <input type="checkbox" name='Accessories' id="element" value="Avant-Garde" onChange={childvalucliked4} />
                                                                    AVANT-GARDE

                                                                </label>
                                                            </div>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Bags" name='Accessories' onChange={childvalucliked4} />
                                                                BAGS

                                                            </label>

                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Body pieces" name='Accessories' onChange={childvalucliked4} />
                                                                BODY PIECES

                                                            </label>

                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Gloves" name='Accessories' onChange={childvalucliked4} />
                                                                GLOVES

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Hair Accessories" name='Accessories' onChange={childvalucliked4} />
                                                                HAIR ACCESSORIES

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Leather" name='Accessories' onChange={childvalucliked4} />
                                                                LEATHER

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Millinery" name='Accessories' onChange={childvalucliked4} />
                                                                MILLINERY

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Opticals" name='Accessories' onChange={childvalucliked4} />
                                                                OPTICALS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Scarves" name='Accessories' onChange={childvalucliked4} />
                                                                SCARVES

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Small Leather" name='Accessories' onChange={childvalucliked4} />
                                                                SMALL LEATHER

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Goods" name='Accessories' onChange={childvalucliked4} />
                                                                GOODS
                                                            ...
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Travel" name='Accessories' onChange={childvalucliked4} />
                                                                TRAVEL

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Umbrellas" name='Accessories' onChange={childvalucliked4} />
                                                                UMBRELLAS
                                                    ...
                                                    <div className='datasinnerradio'>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div>
                                                                {/* Add  more child buttons similarly */}
                                                                <label id='ytg7y'>
                                                                    <input type="checkbox" id="element" value="Avant-Garde" name='Jewellery' onChange={childvalucliked5} />
                                                                    AVANT-GARDE

                                                                </label>
                                                            </div>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Bangles" name='Jewellery' onChange={childvalucliked5} />
                                                                BANGLES

                                                            </label>

                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Bracelets" name='Jewellery' onChange={childvalucliked5} />
                                                                BRACELETS
                                                            ...
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Body Jewellery" name='Jewellery' onChange={childvalucliked5} />
                                                                BODY JEWELLERY

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Brooches" name='Jewellery' onChange={childvalucliked5} />
                                                                BROOCHES

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Cuffs" name='Jewellery' onChange={childvalucliked5} />
                                                                CUFFS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Earrings" name='Jewellery' onChange={childvalucliked5} />
                                                                EARRINGS
                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Fine Jewellery" name='Jewellery' onChange={childvalucliked5} />
                                                                FINE JEWELLERY

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Necklaces" name='Jewellery' onChange={childvalucliked5} />
                                                                NECKLACES

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Rings" name='Jewellery' onChange={childvalucliked5} />
                                                                RINGS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Skulls & Studs" name='Jewellery' onChange={childvalucliked5} />
                                                                SKULLS & STUDS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Timepieces" name='Jewellery' onChange={childvalucliked5} />
                                                                TIMEPIECES
                                                        ...
                                                        <div>
                                                            ...
                                                            <div>
                                                                {/* Add  more child buttons similarly */}
                                                                <label id='ytg7y'>
                                                                    <input type="checkbox" name='Footwear' id="element" value="Boots" onChange={childvalucliked6} />
                                                                    BOOTS

                                                                </label>
                                                            </div>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Casual" name='Footwear' onChange={childvalucliked6} />
                                                                CASUAL

                                                            </label>

                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Flats" name='Footwear' onChange={childvalucliked6} />
                                                                FLATS
                                                            </label>


                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Formal" name='Footwear' onChange={childvalucliked6} />
                                                                FORMAL

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Heels" name='Footwear' onChange={childvalucliked6} />
                                                                HEELS

                                                            </label>
                                                            <label id='ytg7y'>
                                                                <input type="checkbox" id="element" value="Sneakers" name='Footwear' onChange={childvalucliked6} />
                                                                SNEAKERS
